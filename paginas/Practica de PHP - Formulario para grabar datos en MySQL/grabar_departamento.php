...
$departamento = strtoupper(trim($_POST["txtdepartamento"]));
$descripcion = strtoupper(trim($_POST["txtdescripcion"]));
...
if (empty($rows)) // Si detecta VACIO la consulta de busqueda del ID de empleado
{
	...
	$mensaje = "Ese ID deL Departamento ya existe en la base de datos";
...
<body>
	...
	<div id="wrapper">
		...
		<div id="caja3">Formulario para alta de departametnos en la base de datos desde una página web</div>
			...
			<div id="texto1"><br>
				...
				<fieldset style="width: 90%;">
					...
					<div>
						...
						<br />
						<br />
						<b>Nombre del Departamento:</b> <?php echo ($descripcion); ?>
						<br />
						<br />
						...
						<br />
						<br /> -->
						<a href="alta_departamento.php">REGISTRAR OTRO DEPARTAMENTO</a>
						<br />
						<br />
